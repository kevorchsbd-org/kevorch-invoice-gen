    ...
    <div id="invoice-pdf-canvas" className="printable-area bg-white text-black p-8 max-w-[800px] mx-auto border border-gray-200 rounded-none shadow-none font-sans text-xs">
      ...
      <div className="grid grid-cols-2 gap-8 border-b border-gray-300 pb-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          {/* 2. Left Metadata Block (Invoice Date, Due Date, Payment Terms) */}
        ...
        <div className="space-y-4 text-right flex flex-col justify-between items-end">
          ...
          <div className="text-right text-black text-[11px] space-y-0.5 w-full">
            <p className="font-extrabold text-xs uppercase tracking-wider text-black">INVOICE FOR</p>
      ...
      <div className="flex justify-end mb-6">
        <div className="w-72 bg-gray-50 border border-gray-300 rounded-none p-3 text-black space-y-1.5 text-xs">
          ...
          <div className="flex justify-between items-center text-xs font-bold">
            <span className="text-black font-bold">Paid Amount:</span>
            <span className="text-black font-bold">₹{paidAmount.toLocaleString('en-IN')}</span>
          </div>
          <div className="flex justify-between items-center text-sm font-extrabold pt-1 border-t border-gray-300">
            <span className="text-black font-bold">Balance Amount:</span>
            <span className={balanceAmount > 0 ? "text-[#E31B23] text-base font-black" : "text-black font-bold text-xs"}>
